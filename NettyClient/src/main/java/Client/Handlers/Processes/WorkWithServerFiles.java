package Client.Handlers.Processes;
...
public class WorkWithServerFiles {
    ...
    public void receivingFileFromServer(ChannelHandlerContext ctx, ByteBuf buf) throws Exception {
...
//                    System.out.println("Передано - " + receivedFileLength + " .Всего - " + fileLength); // проверочная распечатка сколько передалось байтов
